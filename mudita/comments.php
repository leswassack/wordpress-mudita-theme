...
<div class="comments-area">
    ...
    //https://codex.wordpress.org/Function_Reference/comment_form
        ...
        $args = array(
          ...
          'class_submit'      => 'submit',
          'name_submit'       => 'submit',
          'title_reply'       => __( 'Leave a Reply', 'mudita' ),
          'title_reply_to'    => __( 'Leave a Reply to %s', 'mudita' ),
          'cancel_reply_link' => __( 'Cancel Reply', 'mudita' ),
          'label_submit'      => __( 'POST COMMENT', 'mudita' ),
          'format'            => 'xhtml',
        
          'comment_field' =>  '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun', 'mudita' ) .
            '</label><textarea id="comment" name="comment" placeholder="' . __( 'Comment', 'mudita' ) . '" cols="45" rows="8" aria-required="true">' .
            '</textarea></p>',
          ...
          'logged_in_as' => '<p class="logged-in-as">' .
            sprintf(
            __( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>', 'mudita' ),
