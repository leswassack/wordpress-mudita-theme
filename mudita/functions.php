...
function mudita_scripts() {
    ...
    wp_enqueue_style( 'mudita-font-awesome', get_template_directory_uri() . '/css/font-awesome.css' );
    wp_enqueue_style( 'mudita-jcf-style', get_template_directory_uri() . '/css/jcf.css' );
    wp_enqueue_style( 'mudita-sidr-style', get_template_directory_uri() . '/css/jquery.sidr.light.css' );
    wp_enqueue_style( 'mudita-owl-carousel-style', get_template_directory_uri() . '/css/owl.carousel.css' );
    wp_enqueue_style( 'mudita-scrollbar-style', get_template_directory_uri() . '/css/jquery.mCustomScrollbar.css' );
    wp_enqueue_style( 'mudita-meanmenu-style', get_template_directory_uri() . '/css/meanmenu.css' );
    wp_enqueue_style( 'mudita-style', get_stylesheet_uri() );
    
    wp_enqueue_script( 'mudita-meanmenu', get_template_directory_uri() . '/js/jquery.meanmenu.js', array('jquery'), '2.0.8', true );
    wp_enqueue_script( 'mudita-ie', get_template_directory_uri() . '/js/ie.js', array('jquery'), '3.7.2', true );
	wp_enqueue_script( 'mudita-sidr', get_template_directory_uri() . '/js/jquery.sidr.js', array('jquery'), '20160119', true );
    wp_enqueue_script( 'mudita-owl-carousel', get_template_directory_uri() . '/js/owl.carousel.js', array('jquery'), '2.0.0', true );
    wp_enqueue_script( 'mudita-scrollbar', get_template_directory_uri() . '/js/jquery.mCustomScrollbar.js', array('jquery'), '3.1.5', true );
    wp_enqueue_script( 'mudita-jcf', get_template_directory_uri() . '/js/jcf.js', array('jquery'), '1.2.0', true );
    wp_enqueue_script( 'mudita-jcf-checkbox', get_template_directory_uri() . '/js/jcf.checkbox.js', array('jquery', 'mudita-jcf'), '1.2.0', true );
    wp_enqueue_script( 'mudita-jcf-file', get_template_directory_uri() . '/js/jcf.file.js', array('jquery', 'mudita-jcf'), '1.2.0', true );
    wp_enqueue_script( 'mudita-jcf-number', get_template_directory_uri() . '/js/jcf.number.js', array('jquery', 'mudita-jcf'), '1.2.0', true );
    wp_enqueue_script( 'mudita-jcf-radio', get_template_directory_uri() . '/js/jcf.radio.js', array('jquery', 'mudita-jcf'), '1.2.0', true );
    wp_enqueue_script( 'mudita-jcf-range', get_template_directory_uri() . '/js/jcf.range.js', array('jquery', 'mudita-jcf'), '1.2.0', true );
    wp_enqueue_script( 'mudita-jcf-scrollable', get_template_directory_uri() . '/js/jcf.scrollable.js', array('jquery', 'mudita-jcf'), '1.2.0', true );
    wp_enqueue_script( 'mudita-jcf-select', get_template_directory_uri() . '/js/jcf.select.js', array('jquery', 'mudita-jcf'), '1.2.0', true );
    wp_enqueue_script( 'mudita-custom', get_template_directory_uri() . '/js/custom.js', array('jquery'), '20160119', true );
