...
function mudita_social_links_cb( $show_title = false ){
	...
	<ul class="social-networks">
		...
		<?php } if( $twitter ){ ?>
        <li><a href="<?php echo esc_url( $twitter ); ?>" class="fa fa-twitter" target="_blank" title="<?php esc_attr_e( 'Twitter', 'mudita' );?>"></a></li>
        <?php } if( $pinterest ){ ?>
        <li><a href="<?php echo esc_url( $pinterest ); ?>" class="fa fa-pinterest" target="_blank" title="<?php esc_attr_e( 'Pinterst', 'mudita' );?>"></a></li>
		<?php } if( $linkedin ){ ?>
...
function mudita_footer_credit(){
    ...
    $text .= '<a href="' . esc_url( 'http://raratheme.com/wordpress-themes/mudita/' ) .'" rel="author" target="_blank">' . esc_html__( 'Mudita by: Rara Theme', 'mudita' ) .'</a> &verbar; ';
